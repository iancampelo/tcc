/*
 * Copyright 2012 Jeremy Dixon Licensed under the Apache License, Version 2.0
...
public final class SpinnerUtil {
  ...
  public static <T> Spinner createNewSpinner(@Nonnull View view, int id,
   ...
   */
  @SuppressWarnings("unchecked")
  public static <T> Spinner createNewSpinner(@Nonnull View view, int id, @Nonnull String[] userValues,
  ...
  public static <T> Spinner createNewSpinner(@Nonnull View view, int id, @Nonnull String[] userValues,
    ...
    spinner.setAdapter(new ArrayAdapter<String>(view.getContext(), android.R.layout.simple_spinner_item,
        userValues));
  ...
  /**
   * Android {@link android.widget.AdapterView.OnItemSelectedListener} which maps the User view to the
