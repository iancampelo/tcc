 ...
 */
public class NetComm  extends AsyncTask<String, Integer, String> {
    ...
    public NetComm(AndroidHttpClient hc, HttpContext localContext, TaskResponseListener listener,
